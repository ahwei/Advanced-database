        ...
        <div className="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
            ...
            <div className="bg-white shadow rounded-lg p-6">
              <div className="flex flex-col items-center">
                <img
                  ...
                  alt="Ninomae Ina'nis"
                />
                <h1 className="text-xl font-bold">Ninomae Ina'nis</h1>
                <p className="text-gray-700">Hololive EN 成員</p>
              </div>
              ...
              <div className="flex flex-col">
                ...
                <ul>
                  <li className="mb-2">虛擬偶像兼插畫家</li>
                  <li className="mb-2">「古神的使者」設定</li>
                  <li className="mb-2">愛畫畫與遊戲</li>
                  <li className="mb-2">粉絲群名稱：Takodachi</li>
                  <li className="mb-2">溫柔又幽默的性格</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="col-span-4 sm:col-span-9">
            <div className="bg-white shadow rounded-lg p-6">
              ...
              {/* 經驗 */}
              <h2 className="text-xl font-bold mt-6 mb-4">活動歷程</h2>
              <div className="mb-6">
                <div className="flex justify-between flex-wrap gap-2 w-full">
                  <span className="text-gray-700 font-bold">Hololive 出道</span>
                  <p>
                    <span className="text-gray-700 mr-2">於 Hololive EN</span>
                    <span className="text-gray-700">2020 年 9 月</span>
                  </p>
                </div>
                <p className="mt-2">
              ...
              <div className="mb-6">
                <div className="flex justify-between flex-wrap gap-2 w-full">
                  <span className="text-gray-700 font-bold">藝術創作</span>
                  <p>
                    <span className="text-gray-700 mr-2">自由插畫家</span>
                    <span className="text-gray-700">長期</span>
                  </p>
                </div>
                <p className="mt-2">
              ...
              <div className="mb-6">
                <div className="flex justify-between flex-wrap gap-2 w-full">
                  <span className="text-gray-700 font-bold">遊戲直播</span>
                  <p>
                    <span className="text-gray-700 mr-2">多平台直播</span>
                    <span className="text-gray-700">持續中</span>
                  </p>
                </div>
                <p className="mt-2">
